...
const IndianMarket = () => {
  const [indiandata, setData] = useState([]);

  const get_data =  async() =>{
    try{
      const response = await axios.get(' http://127.0.0.1:8000/indian_market/');
 ...
 const dataEntries = Object.entries(indiandata);
